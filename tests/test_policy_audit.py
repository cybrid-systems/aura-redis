...
def start_agent() -> str:
    ...
    cmd = [
        ...
        "-e", "AURA_REDIS_SEED_PROFILE=conservative",
        "-e", f"AURA_REDIS_POLICY_HEARTBEAT=/work/{HEARTBEAT.name}",
