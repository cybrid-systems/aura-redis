...
### End-to-end eval (throughput + hit-rate)

Full Redis vs aura-redis (lru/lfu/adaptive) throughput **and** dynamic hit-rate tables:
see **`docs/perf-eval.md`** (generated by `./scripts/bench-e2e.sh`).
